...
class Rectangle(Domain):
    ...
    def _random_sampling_boundary(self, n):
        ...
        axis_1 = np.add(self.corner_dl, self._sampling_axis(
            nx, self.corner_dr-self.corner_dl))
        axis_2 = np.add(self.corner_dl, self._sampling_axis(
            ny, self.corner_tl-self.corner_dl))
